...
<img src="./image/로고1.png" id="logo" onclick="location.href='home.jsp'">
 ...
 <!--로그인 버튼-->
	...
	<div id="background">
	<h3 style="text-align:center;">행사 문의글 작성</h3>
	<div id="whitebox">
...
<form action="InsertServlet" method="post">
	...
	<input type="hidden" id="event_number" name="event_number" required value="<%=request.getParameter("event_number") %>">
	
	
	<label for="qna_email">이메일 : </label>
	<input type="email" id="qna_email" name="qna_email" required><br><br>
	
	<input type="submit" value="작성완료" onclick="location.href='Qna_List2.jsp'">
	<input type="submit" value="돌아가기" onclick="location.href='Qna_List2.jsp'">
	</div>
</form>
