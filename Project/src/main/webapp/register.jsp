			...
			<div id="reviewbox">
				...
				<div class="register-Div">
						...
						<table class="center-register">
							<thead class="registerInfo">
									...
									%>
										...
										<tr>
										<th class="one">* 이메일</th>
										<th class="two"><input type="email" id="email" name="email" value="<%=request.getParameter("email")%>" class="input-reg" required></th>
										<th><input type="submit" value="중복확인" id="emailCheck" name="emailCheck" class="checkButton" disabled></th>
										</tr>
										</form>									
									<%}else{%>
										...
										<tr>
										<th class="one">* 이메일</th>
										<th class="two"><input type="email" id="email" name="email" class="input-reg" required></th>
										<th><input type="submit" value="중복확인" id="emailCheck" name="emailCheck" class="checkButton"></th>
										</tr>
										</form>
										<%} %>
							</thead>
					...
					<input type="submit" onclick="Check()" value="회원가입" id="register-add"
							style="width: 80px; height: 30px;" disabled>
				</form>
				</div>
			</div>
		</div>
